  ...
  <table width="728" border="1">
    ...
    <tr>
      ...
      <td colspan="4"><label for="textfield4"></label>
        <input type="text" name="tong" id="textfield4" value="<?php echo isset($tong) ? $tong : ''?>"/></td>
    </tr>
    <tr>
      <td>Tích các số</td>
      <td colspan="4"><label for="textfield5"></label>
        <input type="text" name="tich" id="textfield5" value="<?php echo isset($tich) ? $tich : '' ?>"/></td>
    </tr>
    <tr>
      <td>Tổng các số chẵn</td>
      <td colspan="4"><label for="textfield6"></label>
        <input type="text" name="tong_chan" id="textfield6" value="<?php echo isset($tc) ? $tc : '' ?>"/></td>
    </tr>
    <tr>
      <td>Tổng các số lẻ</td>
      <td colspan="4"><label for="textfield7"></label>
        <input type="text" name="tong_le" id="textfield7" value="<?php echo isset($tl) ? $tl : '' ?>"/></td>
    </tr>
    <tr>
